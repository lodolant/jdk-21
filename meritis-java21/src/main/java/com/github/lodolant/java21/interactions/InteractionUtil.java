...
public class InteractionUtil {
	...
	public static InteractionClient interactWithCustomer(Object interactionTarget) {
		...
		case RecipeIngredient(Ingredient _, int quantity) -> new InteractionClientCheckCalories(quantity);
	...
	public static InteractionKitchen interactWithKitchen(InteractionClient interactionTarget) {
		...
		return switch (interactionTarget) {
		case InteractionClientTakeOrder _ -> InteractionKitchen.GIVE_COMMAND;
		...
		case InteractionClientCheckConsumption _ -> InteractionKitchen.COMMAND_MORE;
		case InteractionClientCheck _ -> throw new ServiceException(HELP.formatted(interactionTarget.getClass().getSimpleName()));
		case InteractionClientCheckCalories _ -> throw new ServiceException(HELP.formatted(interactionTarget.getClass().getSimpleName()));
		};
	}
}
